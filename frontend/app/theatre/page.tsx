      ...
      {() => (
        <main style={{ padding: 24, maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
            <div>
              <h1 style={{ margin: 0, fontSize: 36 }}>Theatre / Recovery Board</h1>
              <p style={{ color: "#94a3b8" }}>Live theatre pressure, prep blockers, and recovery handoffs.</p>
            </div>
          ...
          {!board ? <p style={{ marginTop: 20 }}>Loading theatre board...</p> : null}
