...
DEFAULT_PEOPLE = [
    (101, "Reception 1", "reception", "front_door"),
    (102, "Reception 2", "reception", "front_door"),
    (201, "Insurance Admin", "insurance/admin", "admin"),
    (301, "Imaging Lead", "imaging lead", "imaging"),
    (302, "Clinical Lead", "clinical lead", "clinical"),
    (401, "Surgical Lead", "surgical lead", "theatre"),
    (402, "Anaesthesia", "anaesthesia", "theatre"),
    (501, "Nurse 1", "nurse", "ward"),
    (502, "Nurse 2", "nurse", "ward"),
    (601, "PCA 1", "PCA", "support"),
    (701, "Client Contact", "client contact", "client"),
    (801, "Ops Manager", "ops manager", "ops"),
]

DEFAULT_RESOURCES = [
    ("reception", "Reception", "front_door"),
    ("admin-queue", "Admin queue", "admin"),
    ("consult-room", "Consult room", "consult"),
    ("mri", "MRI", "imaging"),
    ("ct", "CT", "imaging"),
    ("theatre-1", "Theatre 1", "theatre"),
    ("theatre-2", "Theatre 2", "theatre"),
    ("recovery", "Recovery", "care"),
    ("ward", "Ward", "care"),
    ("client-contact", "Client contact", "communication"),
