...
function MobileHospitalAgendaV15() {
  ...
  return <main className="ha">
    <style>{css}</style>
    <header className="hero"><span>LucyWorks OS · mobile hospital agenda v15</span><h1>Hospital today</h1><p>Patients, places, times, staff and blockers in one phone view.</p><nav><Link href="/workspace">Patient command</Link><Link href="/referral-intake">New referral</Link><Link href="/input">Quick input</Link></nav></header>
...
export function ResponsiveHospitalBoardV15() {
  ...
  return mobile ? <MobileHospitalAgendaV15 /> : <HospitalMasterBoardV11 />;
}
