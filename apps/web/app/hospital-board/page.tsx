...
type BoardView = "overview" | "operations";
        ...
        <div className="hospital-shell">
          ...
          <header className="hospital-shell__header">
            ...
            <nav className="hospital-shell__views" aria-label="Hospital board views">
              ...
              <button type="button" className={view === "operations" ? "active" : ""} onClick={() => setView("operations")}>Live board</button>
            </nav>
          ...
          <main>
            {view === "overview" ? <HospitalCommandOverview onOpenLiveBoard={() => setView("operations")} /> : <ResponsiveHospitalBoardV15 />}
          </main>
        </div>
      )}
    </AuthGuard>
