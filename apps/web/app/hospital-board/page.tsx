...
import { HospitalWorkforce } from "@/components/hospital-workforce";
...
@media(max-width:620px){.hospital-shell__identity h1{font-size:15px}.hospital-shell__identity>div:last-child>span{font-size:9px}.hospital-shell__mark{width:31px;height:31px}.hospital-shell__header{grid-template-columns:1fr}.hospital-shell__views{justify-self:stretch;display:grid;grid-template-columns:repeat(4,1fr);width:100%}.hospital-shell__views button{font-size:10px;padding:6px 5px}.hospital-shell__links{grid-column:1}.hospital-shell__links a:not(.primary){display:none}.hospital-shell__user{display:none}}
`;
