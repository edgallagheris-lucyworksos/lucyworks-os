      ...
      <div className="hospital-shell">
        ...
        <header className="hospital-shell__header">
          ...
          <nav className="hospital-shell__links" aria-label="Hospital navigation">
            ...
            <Link href="/episode-command">Episode control</Link>
...
/* The outer product shell replaces historical component headers that expose internal version labels. */
.hospital-shell .mb>.hero,.hospital-shell .ha>.hero{display:none!important}
.hospital-shell .mb,.hospital-shell .ha{padding-top:8px!important}
